        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ArrangementFilePath = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArrangementInstruments", x => new { x.ArrangementsId, x.InstrumentsId });
                    table.ForeignKey(
                        name: "FK_ArrangementInstruments_Arrangements_ArrangementsId",
                        column: x => x.ArrangementsId,
                        principalTable: "Arrangements",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ArrangementInstruments_Instruments_InstrumentsId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PerformanceDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArrangementGames", x => new { x.ArrangementsId, x.GamesId });
                    table.ForeignKey(
                        name: "FK_ArrangementGames_Arrangements_ArrangementsId",
                        column: x => x.ArrangementsId,
                        principalTable: "Arrangements",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ArrangementGames_Games_GamesId",
                        column: x => x.GamesId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArrangementGames_GamesId",
                table: "ArrangementGames",
                column: "GamesId");

            migrationBuilder.CreateIndex(
                name: "IX_ArrangementInstruments_InstrumentsId",
                table: "ArrangementInstruments",
